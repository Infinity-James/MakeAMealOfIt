...
static NSString *const kCellIdentifier	= @"FridgeCellIdentifier";

#pragma mark - Fridge View Controller Private Class Extension

@interface FridgeViewController () <UITableViewDataSource, UITableViewDelegate> {}
...
#pragma mark - Fridge View Controller Implementation
		 ...
		 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	cell.textLabel.text					= @"Fridge Food";
...
- (void)addConstraintsForTableView
{
	...
	constraints							= [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(==60)-[tableView]|" options:kNilOptions metrics:nil views:self.viewsDictionary];
